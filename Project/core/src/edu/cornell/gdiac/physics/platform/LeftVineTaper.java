 ...
 */
public class LeftVineTaper extends PolygonObstacle {


    /**
     * Create a new VineModel with degenerate settings
     */
    public LeftVineTaper() {
        super(new float[]{0,0,1,0,1,1,0,1},0,0);
    }

    public LeftVineTaper(float[] points, float x, float y) { super(points,x,y);}
    ...
    public void draw(GameCanvas canvas) {
        ...
        canvas.draw(getTexture(),Color.WHITE,-20 ,-1,getX()*drawScale.x,getY()*drawScale.y,getAngle(), .55f*PlatformController.worldX, .55f*PlatformController.worldY);
