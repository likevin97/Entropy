 ...
 */
public class RightVineTaper extends PolygonObstacle {


    /**
     * Create a new VineModel with degenerate settings
     */
    public RightVineTaper() {
        super(new float[]{0,0,1,0,1,1,0,1},0,0);
    }

    public RightVineTaper(float[] points, float x, float y) { super(points,x,y);}
    ...
    public void draw(GameCanvas canvas) {
        ...
        canvas.draw(getTexture(),Color.WHITE,0,-2,getX()*drawScale.x,getY()*drawScale.y,getAngle(), PlatformController.worldX,PlatformController.worldY);
