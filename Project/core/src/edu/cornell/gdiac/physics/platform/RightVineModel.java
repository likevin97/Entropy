 ...
 */
public class RightVineModel extends PolygonObstacle {


    /**
     * Create a new VineModel with degenerate settings
     */
    public RightVineModel() {
        super(new float[]{0,0,1,0,1,1,0,1},0,0);
    }

    public RightVineModel(float[] points, float x, float y) { super(points,x,y);}
    ...
    public void draw(GameCanvas canvas) {
        ...
        canvas.draw(getTexture(),Color.WHITE,18,0,getX()*drawScale.x,getY()*drawScale.y,getAngle(), 0.55f * PlatformController.worldX,0.55f * PlatformController.worldY);
