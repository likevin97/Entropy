...
public class InputController {
	...
	/** Direction root grows */
	private int dir;
	/** An X-Box controller (if it is connected) */
	XBox360Controller xbox;

	public static int leftInput = Input.Keys.A;
	public static int rightInput = Input.Keys.D;
	...
	private void readKeyboard(Rectangle bounds, Vector2 scale, boolean secondary) {
		...
		if (Gdx.input.isKeyPressed(rightInput)) {
			horizontal += 1.0f;
		}
		if (Gdx.input.isKeyPressed(leftInput)) {
			horizontal -= 1.0f;
		}
